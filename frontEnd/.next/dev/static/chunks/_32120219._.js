...
function AuthProvider({ children }) {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].getMe();
    ...
    const signup = async (data)=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].signup({
            name,
            email,
            password,
            role
    ...
    const login = async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].login(data);
        if ("TURBOPACK compile-time truthy", 1) {
            localStorage.setItem('token', response.data.token);
        }
        setUser(response.data.user);
...
//# sourceMappingURL=_32120219._.js.map